...
var singlePluralAssertions = []dict{
	...
	{"move", "moves", true, true},
	{"movie", "movies", true, true},
	{"news", "news", true, true},
	...
	{"psi", "psis", true, true},
	{"puppy", "puppies", true, true},
	{"query", "queries", true, true},
